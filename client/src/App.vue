  ...
  <div class="app">
    ...
    <main>
      ...
      <div id="ask_question">
        ...
        <Example path="/ask/i-declare-bankruptcy" season="4" episode="4" character="Oscar"
      ...
      <div id="ask_question_character">
        ...
        <Example path="/characters/dwight/ask/bears-eat-beets" season="3" episode="20"
      ...
      <div id="random_line">
        ...
        <Example path="/random" season="5" episode="22" character="Michael"
      ...
      <div id="random_line_character">
        ...
        <Example path="/characters/dwight/random" season="1" episode="1"
      ...
      <div id="random_line_season_character">
        ...
        <Example path="/seasons/1/characters/michael/random" episode="6"
      ...
      <div id="random_line_season_episode_character">
        ...
        <Example path="/seasons/2/episodes/1/characters/michael/random"
